...
public class MedicoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Medico> getMedicoById(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Medico> updateMedico(@PathVariable String id, @RequestBody Medico medicoDetails) {
        Optional<Medico> medico = medicoRepository.findById(id);
        if (medico.isPresent()) {
